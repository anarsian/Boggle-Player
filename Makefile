#############################################################################
# Makefile for building: P4_Solo
# Generated by qmake (3.0) (Qt 5.0.1) on: Tue Dec 3 18:06:04 2013
# Project:  P4_Solo.pro
# Template: app
# Command: /software/common/qt-5.0.1/bin/qmake -o Makefile P4_Solo.pro
#############################################################################
...
Makefile: P4_Solo.pro /software/common/qt-5.0.1/mkspecs/linux-g++/qmake.conf /software/common/qt-5.0.1/mkspecs/features/spec_pre.prf \
		/software/common/qt-5.0.1/mkspecs/common/shell-unix.conf \
		/software/common/qt-5.0.1/mkspecs/common/unix.conf \
		/software/common/qt-5.0.1/mkspecs/common/linux.conf \
		/software/common/qt-5.0.1/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d .tmp/P4_Solo1.0.0 || $(MKDIR) .tmp/P4_Solo1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/P4_Solo1.0.0/ && $(COPY_FILE) --parents baseboggleplayer.h boggleboard.h boggleplayer.h boggleutil.h mainwindow.h ui_mainwindow.h .tmp/P4_Solo1.0.0/ && $(COPY_FILE) --parents boggleboard.cpp boggleplayer.cpp boggleutil.cpp main.cpp mainwindow.cpp .tmp/P4_Solo1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/P4_Solo1.0.0/ && (cd `dirname .tmp/P4_Solo1.0.0` && $(TAR) P4_Solo1.0.0.tar P4_Solo1.0.0 && $(COMPRESS) P4_Solo1.0.0.tar) && $(MOVE) `dirname .tmp/P4_Solo1.0.0`/P4_Solo1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/P4_Solo1.0.0
